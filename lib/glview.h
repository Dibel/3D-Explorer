...
public:
    ...
    explicit GLView(const QSurfaceFormat &format, QWindow *parent=0);
    ~GLView();
    ...
    GLView::Options options() const;
    void setOptions(GLView::Options value);
    void setOption(GLView::Option option, bool value);
    ...
    GLView::StereoType stereoType() const;
    void setStereoType(GLView::StereoType type);
...
Q_DECLARE_OPERATORS_FOR_FLAGS(GLView::Options)
